    ...
    public void execute(String command, Terminal2Callback callback, boolean isNewThread) {
        ...
        Runnable runnable = () -> {
            ...
            try {
                ...
                String prootPath = nativeDir + "/libproot.so";
                ...
                processBuilder.environment().put("PROOT_LOADER", nativeDir + "/libproot-loader.so");
                if (DeviceUtils.is64bit()) processBuilder.environment().put("PROOT_LOADER_32", nativeDir + "/libproot-loader32.so");
