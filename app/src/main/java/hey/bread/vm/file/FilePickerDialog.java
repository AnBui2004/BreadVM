...
import hey.bread.vm.databinding.DialogFilePickerBinding;
import hey.bread.vm.databinding.ListFileBinding;
...
public class FilePickerDialog extends DialogFragment {
    ...
    private int getIcon(int type) {
        return switch (type) {
            ...
            case ROM_FILE -> R.drawable.bread_vm_24px;
