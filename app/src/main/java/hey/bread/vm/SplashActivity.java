...
import hey.bread.vm.crashtracker.CrashTrackerData;
import hey.bread.vm.crashtracker.CrashTrackerUtils;
import hey.bread.vm.crashtracker.LastCrashActivity;
...
public class SplashActivity extends AppCompatActivity {
    ...
    public void setupFiles() {
        ...
        if (!vDir.exists()) {
            if (!vDir.mkdirs())
                Log.e(TAG, AppConfig.maindirpath + ": Directory creation failed!");
        }
