package hey.bread.vm.main.romstore;
...
import hey.bread.vm.databinding.FragmentHomeRomStoreBinding;
...
public class RomStoreFragment extends Fragment {
    ...
    private void loadFromServer() {
        ...
        Retrofit2Utils.get(AppConfig.dataRaw + "vroms-store.json", ((isSuccess, body, status, error) -> {
            binding.linearload.setVisibility(View.GONE);
            if (isSuccess) {
                if (!body.isEmpty())
                    contentJSON = body;
