...
public class LogItem implements Parcelable {
    ...
    BreadStatus.LogLevel mLevel = BreadStatus.LogLevel.INFO;
    ...
    public LogItem(BreadStatus.LogLevel loglevel, int verblevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
        mVerbosityLevel = verblevel;
    }

    public LogItem(BreadStatus.LogLevel level, int resId, Object... args) {
        mLevel = level;
        mResourceId = resId;
        mArgs = args;
    }

    public LogItem(BreadStatus.LogLevel loglevel, String msg) {
        mLevel = loglevel;
        mMessage = msg;
    }


    public LogItem(BreadStatus.LogLevel loglevel, int ressourceId) {
    ...
    public LogItem(Parcel in) {
        ...
        mLevel = BreadStatus.LogLevel.getEnumByValue(in.readInt());
        logtime = in.readLong();
    }
    ...
    public BreadStatus.LogLevel getLogLevel() {
        return mLevel;
    }
    ...
    private String getAppInfoString(Context c) {
        ...
        try {
            ...
            if (!Arrays.equals(digest, BreadStatus.oficialkey) && !Arrays.equals(digest, BreadStatus.oficialdebugkey))
                apksign = "";
