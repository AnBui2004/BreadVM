...
import hey.bread.qemu.utils.RamInfo;
...
import hey.bread.vm.manager.BatteryEmulatorManager;
import hey.bread.vm.manager.FirmwareManager;
import hey.bread.vm.manager.FormatManager;
import hey.bread.vm.manager.ParamManager;
import hey.bread.vm.manager.QemuManager;
import hey.bread.vm.manager.VmFileManager;
import hey.bread.vm.manager.WifiCardEmulatorManager;
import hey.bread.vm.settings.ItemSettingsSelector;
    ...
    public static String env(Activity activity, DataMainRoms vmData) {
        ...
        if (!ParamManager.hasMemory(extraParams)) {
            ...
            if (vmConfigs.memory > 0) {
                ...
                memoryParams += (int) (RamInfo.breadMemory(activity) / 100 * 80);
            }
        }
        ...
        if (!sound.isEmpty()) {
            ...
            soundParams = " -device " +
                    ...
                    VmFileManager.getAudioRaw(BreadVmApplication.getContext(), vmConfigs.vmID);
        }
...
//            File hdd1File = new File(filesDir + "/data/BreadVM/hdd1.qcow2");
//
//            if (hdd1File.exists()) {
//                hdd1 = "-drive";
//                hdd1 += " media=disk";
...
//            }
            ...
            if (vmConfigs.isUseDefaultBios) {
                ...
                if (MainSettingsManager.getArch(activity).equals("PPC")) {
                    ...
                    bios = "-bios ";
                    bios += AppConfig.basefiledir + "bios-256k.bin";
                }
            }
