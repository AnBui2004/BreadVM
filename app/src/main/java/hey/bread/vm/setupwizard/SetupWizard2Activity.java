package hey.bread.vm.setupwizard;
...
import hey.bread.vm.MainService;
import hey.bread.vm.R;
import hey.bread.vm.VMManager;
import hey.bread.vm.creator.utils.VMCreatorSelector;
import hey.bread.vm.databinding.ActivitySetupWizard2Binding;
import hey.bread.vm.databinding.SetupQemuDoneBinding;
...
import hey.bread.vm.utils.TarUtils;
    ...
    private void uiController(int step, String log) {
        ...
        if (step == STEP_REQUEST_PERMISSION) {
            ...
            if (isNotEnoughStorageSpace) {
                ...
                binding.tvErrorTitle.setText(getString(R.string.bread_vm_cannot_run_on_this_device));
        ...
        if (uri != null) {
            ...
            if (FileUtils.getFileNameFromUri(this, uri).endsWith(abi + ".tar.gz")) {
                ...
                DialogUtils.oneDialog(this,
                        ...
                        getString(R.string.please_select) + " bread-vm-" + abi + ".tar.gz.",
