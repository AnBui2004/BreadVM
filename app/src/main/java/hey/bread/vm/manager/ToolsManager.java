            ...
            if (!FileUtils.isFileExists(AppConfig.basefiledir + "virtio-win.iso")) {
                ...
                activity.runOnUiThread(() -> DialogUtils.twoDialog(
                        ...
                        () -> new Thread(() -> {
                            ...
                            NotificationManagerCompat manager = NotificationManagerCompat.from(BreadVmApplication.getContext());
                            NotificationCompat.Builder builder = new NotificationCompat.Builder(BreadVmApplication.getContext(), NotificationUtils.downloadChannelId)
                                ...
                                public void onResult(boolean success, String path, Throwable error) {
                                    if (success) {
                                        ...
                                        if (DialogUtils.isAllowShow(activity)) {
                                            ...
                                            Context context = BreadVmApplication.getContext();
