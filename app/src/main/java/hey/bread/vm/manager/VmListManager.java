...
import hey.bread.vm.utils.UniversalPickerDialog;
...
public class VmListManager {
    ...
    public static boolean isValid(String filePath) {
        try {
            ArrayList<HashMap<String, Object>> vmList = new Gson().fromJson(FileUtils.readAFile(filePath), new TypeToken<ArrayList<HashMap<String, Object>>>() {
            }.getType());
