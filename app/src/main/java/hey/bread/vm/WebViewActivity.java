...
import hey.bread.vm.databinding.ActivityWebViewBinding;
...
public class WebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("url") && getIntent().getStringExtra("url") != null) {
            ...
            binding.webview.loadUrl(AppConfig.website);
            oringialDomain = Uri.parse(AppConfig.website).getAuthority();
        }
