...
import hey.bread.vm.logger.LogItem;
...
public class LogsAdapter extends RecyclerView.Adapter<LogsAdapter.logViewHolder>
        implements BreadStatus.LogListener, Handler.Callback,
    ...
    public LogsAdapter(LinearLayoutManager layoutManager, Context context, boolean forceLightText) {
        ...
        setLogLevel(BreadStatus.LogLevel.DEBUG.getInt());
        ...
        BreadStatus.addLogListener(this);
    }
    ...
    private void initLogBuffer() {
        allEntries.clear();
        Collections.addAll(allEntries, BreadStatus.getlogbuffer());
        initCurrentMessages();
    }
