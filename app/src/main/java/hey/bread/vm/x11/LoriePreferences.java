...
import hey.bread.vm.x11.utils.SamsungDexUtils;
...
public class LoriePreferences extends AppCompatActivity implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    static final String ACTION_PREFERENCES_CHANGED = "hey.bread.vm.x11.ACTION_PREFERENCES_CHANGED";
    ...
    public static class Receiver extends BroadcastReceiver {
                            ...
                            case "enableAccessibilityServiceAutomatically": {
                                if (!"true".equals(newValue))
                                    ...
                                    sendResponse(remote, 1, 1, "Permission denied.\n" +
                                            ...
                                            "Please, launch this command using ADB:\n" +
                                            "adb shell pm grant hey.bread.vm.x11 android.permission.WRITE_SECURE_SETTINGS");
                                    return;
                                }
        ...
        public static void main(String[] args) {
            ...
            Intent i = new Intent("hey.bread.vm.x11.CHANGE_PREFERENCE");
