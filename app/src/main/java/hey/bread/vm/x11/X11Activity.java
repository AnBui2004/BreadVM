...
import static hey.bread.vm.x11.CmdEntryPoint.ACTION_START;
import static hey.bread.vm.x11.LoriePreferences.ACTION_PREFERENCES_CHANGED;
...
import hey.bread.vm.databinding.ActivityX11Binding;
import hey.bread.vm.x11.extrakeys.ExtraKeysInfo;
import hey.bread.vm.x11.input.InputEventSender;
import hey.bread.vm.x11.input.InputStub;
import hey.bread.vm.x11.input.TouchInputHandler;
import hey.bread.vm.x11.utils.ImeHeightProvider;
import hey.bread.vm.x11.utils.KeyInterceptor;
import hey.bread.vm.x11.utils.TermuxX11ExtraKeys;
import hey.bread.vm.x11.utils.X11ToolbarViewPager;
...
public class X11Activity extends AppCompatActivity {
    public static final String ACTION_STOP = "hey.bread.vm.x11.ACTION_STOP";
    public static final String ACTION_CUSTOM = "hey.bread.vm.x11.ACTION_CUSTOM";
    ...
    Notification buildNotification() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, getNotificationChannel(mNotificationManager))
                ...
                .setSmallIcon(R.drawable.bread_vm_24px)
