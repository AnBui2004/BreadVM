...
public class CmdEntryPoint extends ICmdEntryInterface.Stub {
    public static final String ACTION_START = "hey.bread.vm.x11.CmdEntryPoint.ACTION_START";
    ...
    private static void initEntryPoint() {
        ...
        try {
            ApplicationInfo appInfo = ctx.getPackageManager().getApplicationInfo(BuildConfig.APPLICATION_ID, 0);
            String libPath = appInfo.nativeLibraryDir + "/libXlorie.so";
            System.load(libPath);
        } catch (Exception | UnsatisfiedLinkError e) {
            Log.e("CmdEntryPoint", "Failed to load libXlorie.so", e);
