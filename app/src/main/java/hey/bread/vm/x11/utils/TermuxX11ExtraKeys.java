package hey.bread.vm.x11.utils;

import static hey.bread.vm.x11.extrakeys.ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
...
import hey.bread.vm.x11.extrakeys.*;
import hey.bread.vm.x11.LoriePreferences;
import hey.bread.vm.x11.X11Activity;
import hey.bread.vm.x11.extrakeys.ExtraKeyButton;
import hey.bread.vm.x11.extrakeys.ExtraKeysConstants;
import hey.bread.vm.x11.extrakeys.ExtraKeysInfo;
import hey.bread.vm.x11.extrakeys.ExtraKeysView;
import hey.bread.vm.x11.extrakeys.SpecialButton;
...
public class TermuxX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "hey.bread.vm.x11.start_preferences_activity";
