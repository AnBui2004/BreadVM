...
public class QMPClient {
    ...
    public QMPClient(String host, int port) throws IOException {
        ...
        try {
            ...
            BreadStatus.logError("<font color='red'>VTERM ERROR: >" + e.getMessage().toString() + "</font>");
        }
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            BreadStatus.logError("<font color='#FFC107'>VTERM: >" + "Response: " + client.receiveResponse() + "</font>");
