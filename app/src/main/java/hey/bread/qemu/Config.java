...
public class Config {
    ...
    public static final String ACTION_START = "hey.bread.qemu.action.STARTVM";
    ...
    // App config
    public static final String APP_NAME = "Bread VM";
    ...
    public static String wakeLockTag = "bread:wakelock";
    public static String wifiLockTag = "bread:wifilock";
    ...
    public static String destLogFilename = "breadlog.txt";

    public static String notificationChannelID = "bread";
    public static String notificationChannelName = "bread";
    ...
    public static String logFilePath = cacheDir + "/bread/bread-log.txt";
    ...
    public static String defaultVNCUsername = "bread";
    ...
    // App config
    public static final String datadirpath = BreadVmApplication.getApp().getExternalFilesDir("data")+"/";

	public static String machinename = "Bread VM";
