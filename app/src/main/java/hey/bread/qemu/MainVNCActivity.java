...
import hey.bread.vm.Fragment.ControlersOptionsFragment;
import hey.bread.vm.Fragment.LoggerDialogFragment;
import hey.bread.vm.R;
import hey.bread.vm.databinding.ActivityVncBinding;
import hey.bread.vm.databinding.ControlsFragmentBinding;
import hey.bread.vm.databinding.DesktopControlsBinding;
import hey.bread.vm.databinding.GameControlsBinding;
import hey.bread.vm.databinding.SendKeyDialogBinding;

import hey.bread.vm.VMManager;
import hey.bread.vm.manager.QmpSender;
import hey.bread.vm.manager.VNCKeyManager;
import hey.bread.vm.manager.VmAudioManager;
import hey.bread.vm.manager.VmFileManager;
import hey.bread.vm.manager.VmControllerDialog;
import hey.bread.vm.utils.DeviceUtils;
import hey.bread.vm.utils.DialogUtils;
import hey.bread.vm.utils.FileUtils;
import hey.bread.vm.utils.ListUtils;
...
//                vnc_canvas_layout_params.addRule(RelativeLayout.CENTER_IN_PARENT);
    ...
    public void onPause() {
        //MainService.updateServiceNotification("Bread VM Running in Background");
        super.onPause();
